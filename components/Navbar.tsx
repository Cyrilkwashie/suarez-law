...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    dropdown: [
      ...
      { label: "Cruise Ship Accidents", href: "/practice-areas/cruise-ship-accidents" },
      { label: "Brain & Spinal Injury", href: "/practice-areas/brain-spinal" },
      { label: "Spinal Cord Injury", href: "/practice-areas/spinal-cord-injury" },
      { label: "Pedestrian Accidents", href: "/practice-areas/pedestrian-accidents" },
      { label: "Train Accidents", href: "/practice-areas/train-accidents" },
      { label: "Product Liability", href: "/practice-areas/product-liability" },
      { label: "Serious Injury", href: "/practice-areas/serious-injury" },
    ],
  },
  {
