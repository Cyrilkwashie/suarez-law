...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    dropdown: [
      ...
      { label: "Cruise Ship Accidents", href: "/miami-cruise-ship-accident-attorney" },
      { label: "Slip and Fall", href: "/miami-slip-fall-accident-attorney" },
      { label: "Spinal Cord Injury", href: "/miami-spinal-cord-injury-attorney" },
      { label: "Boating Accidents", href: "/miami-boating-accident-attorney" },
      { label: "Truck Accidents", href: "/miami-truck-accident-lawyer" },
      { label: "Pedestrian Accidents", href: "/miami-pedestrian-accident-attorney" },
      { label: "Brain Injury", href: "/miami-brain-injury-attorney" },
      { label: "Train Accidents", href: "/miami-train-accident-attorney" },
      { label: "Semi Truck Accidents", href: "/miami-semi-truck-accident-attorney" },
      { label: "Product Liability", href: "/miami-product-liability-attorney" },
      { label: "Serious Injury", href: "/miami-serious-injury-lawyer" },
    ],
  },
  {
